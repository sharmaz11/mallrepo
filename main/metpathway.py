...
for i in range(0,phase1.shape[1]-1):
    for j in range((i+1),phase1.shape[1]):
        ...
        #print(dat)
        #list1.append(a)
        dat.to_csv("phase1.csv",mode="a",header=False,index=False)
        count+=1
...
for i in range(0,phase1_2.shape[1]):
    for j in range((i+1),6):
        ...
        #print(dat)
        #list1.append(a)
        dat.to_csv("phase1_2.csv",mode="a",header=False,index=False)
        count+=1
count=0 
for i in range(0,phase1_3.shape[1]-1):
    for j in range((i + 1), phase1_3.shape[1]):
        ...
        print(dat)
        #list1.append(a)
        dat.to_csv("phase1_3.csv",mode="a",header=False,index=False)
        count+=1
